                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo $action;?>" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control select2 pull-right" name="status" value="<?php echo $status;?>" style="width: 100%;">
											<option selected="selected">Kembali</option>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <a href="<?php echo site_url('pengembalian'); ?>" class="btn btn-default">Kembali</a>
